...
type QueryTransactionResponse struct {
	Transaction *peer.ProcessedTransaction
	Error       error
}
...
func decodeTransaction(payload []byte) (*peer.ProcessedTransaction, error) {
...
func decodeBlock(payload []byte) (*common.Block, error) {
